...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto ">
      ...
      <h3 id="countdown"></h3>
      <p class="lead fw-normal">باقي على التسجيل للسحب على ربح نسخه مجانية من البرنامج</p>
  ...
  <li class="list-group-item">تابعني على تويتر</li>
  <li class="list-group-item">السحب عشوائي</li>
  <li class="list-group-item">اللهم صلي وسلم على نبينا محمد</li>
</ul>
    </div>
